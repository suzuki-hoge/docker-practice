...
var parse_image_size_1 = require("./helpers/parse_image_size");
    ...
    return function (state, silent) {
        ...
        if (pos < max && state.src.charCodeAt(pos) === 0x28 /* ( */) {
            ...
            if (pos - 1 >= 0) {
                ...
                if (code === 0x20) {
                    res = parse_image_size_1.parseImageSize(state.src, pos, state.posMax);
                    if (res.ok) {
                        width = res.width;
                        height = res.height;
                        pos = res.pos;
